...
###$R^2$ statistic
The RSE provides an absolute measure of lack of fit of the model to the data and it is measured in the units of Y. The $R^2$ statistic provides an alternative measure of fit which is independent of Y and it is in the range between 0 and 1. The value close to 1 is considered as good fit. For example if the value is 0.8 which means that the model is 80% fit to the data. As compared to RSE, the $R^2$ statistic explains how well the model fit to the data since the value has a 
