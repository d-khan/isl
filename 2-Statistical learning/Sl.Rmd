...
If the goal is to predict whether the sales is going to go up or down then this is referred to as a classification problem.
...
### Where irreducible error comes from?
...
![Tradeoff between flexibility and interpretability using different statistical learning methods.](2-7.png)
