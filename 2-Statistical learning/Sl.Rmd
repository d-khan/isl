...
What is _Bias_?  
_Bias_ refers to the error that is introduced by approximating a real-life problem. It is unlikely that any real-life problem truly has such a simple linear relationship, and so performing linear regression will undoubtedly result in some bias in the estimate of $\hat f$. In other words, __more flexible methods gives high variance but low bias, and least flexible methods gives low variance but high bias.__
